...
$product_id = $node->field_product[$language][0]['product_id'];
...
<div class="print-content">
    <?php
    print $node->field_description[$language][0]['value'];
    $uri = $product->field_images[$language][0]['uri'];
    $realuri = file_create_url($uri);?>
    <img src="<?php print $realuri; ?>"/>
</div>
