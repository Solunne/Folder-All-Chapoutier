...
?>
<div class="col-xs-12 col-md-4 vert-offset-bottom-1 product">
            ...
            <div class="pull-left bio-color">
                <?php if(isset($content['field_bio'])){ ?>
                    ...
                    <span class="pull-left bio">
                        <img src="<?php print $tooltipimage; ?>" class="bio" data-placement="top" data-trigger="hover" data-toggle="popover" title="<?php print $bio->name; ?>" data-content="<?php print $bio->field_tooltip['und'][0]['value']; ?>"/>
                    </span>
                <?php } ?>
