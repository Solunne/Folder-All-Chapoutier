...
var translatedCookie = {
  ...
  'de': {accept_text: 'Ich stimme zu', more_text: 'Finde mehr heraus', text: 'Die Cookie-Einstellungen auf dieser Website sind Cookies, damit Sie das beste Navigationserlebnis zu geben.', policy_url: '/de/cookies'},
  'zh-hans': {accept_text: '我同意', more_text: '了解更多', text: '本网站上的cookie设置被设置为允许cookies来给你最好的导航体验。', policy_url: '/zh-hans/cookies'}
};
